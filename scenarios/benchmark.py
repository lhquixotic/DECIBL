...
def load_datasets(args: argparse.Namespace):
    ...
    for dataset_id in dataset_ids:
        ...
        dataset_filename = "./scenarios/datasets/original/" + str(dataset_id)+"-" + task_dict[dataset_id]+"/"
        ...
        # load pkl if exists
        pro_dataset_fname = "./scenarios/datasets/processed/"+ str(dataset_id)+"-" + task_dict[dataset_id]+"/" 
        if args.is_demo:
            pro_dataset_fname = "./scenarios/datasets/processed_demo/"+ str(dataset_id)+"-" + task_dict[dataset_id]+"/"
...
def get_joint_scenario_benchmark(args:argparse.Namespace):
    ...
    print("-"*80)
    print("Loaded datasets completed, {} tasks in total.".format(len(com_test_dataset)))
