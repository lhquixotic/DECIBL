...
from learners import pnn_learner, vanilla_learner, multiple_learner, joint_learner, dem_learner, gsm_learner, ewc_learner
...
if __name__ == '__main__':
    ...
    if args.train_method == "Joint":
        ...
        if args.train_method == "EWC":
            model_ = social_stgcnn.social_stgcnn
            learner_ = ewc_learner.EWCLearner
